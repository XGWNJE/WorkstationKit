...
整理者已把安装包、中文语言文件与 Win7 系统镜像放在夸克网盘，链接永久有效：

**https://pan.quark.cn/s/3577e8370038**　　提取码：`xLms`

包内含清单《说明与校验》，列出每个文件的大小与校验值；**同样内容也放在本仓库**，见 [netdisk-manifest.md](netdisk-manifest.md)。**系统镜像约 3.2 GB**，下载前留意网盘自身的流量或速度限制。
...
| 文件大小 | 3,420,557,312 字节（约 3.2 GB） |
| 现成镜像（免注册） | **见上文「网盘镜像」一节** —— 同一分享里已包含该镜像 |
...
| Win7 旗舰版 SP1 x64 镜像 | **夸克网盘镜像**（免注册），或 MSDN 原版镜像站 | **SHA1** 比对 |
